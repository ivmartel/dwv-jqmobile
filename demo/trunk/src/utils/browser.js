...
{
    return dwvjq.browser.askModernizr("xhrresponsetype") &&
...
{
    return dwvjq.browser.askModernizr("dataview") && dwvjq.browser.askModernizr("typedarrays");
};
...
dwvjq.browser._hasTypedArraySlice = (typeof Uint8Array.prototype.slice !== "undefined");
