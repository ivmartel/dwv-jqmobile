...
<head>
	...
	<title>dwv Namespace: tests</title>
...
<div class="row">
	...
	<h1 class="page-title">Namespace: tests</h1>
<section>
		...
		<ul class="dummy">
			<li>
				<a href="tests_visual_sauce.js.html">tests/visual/sauce.js</a>,
				 <a href="tests_visual_sauce.js.html#sunlight-1-line-4">line 4</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".sauceTest"><span class="type-signature">&lt;static> </span>sauceTest(caps)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Desired capabilities for the webdriver. Minimum of  {'browserName', 'version', 'platform'}.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="tests_visual_sauce.js.html">tests/visual/sauce.js</a>,
				 <a href="tests_visual_sauce.js.html#sunlight-1-line-52">line 52</a>
			</li>
		</ul>
	</dd>
	...
	<dd class="tag-see">
		<ul>
			<li><a href="https://wiki.saucelabs.com/display/DOCS/Platform+Configurator%0D%20%20for%20saucelabs%20possibilities.">https://wiki.saucelabs.com/display/DOCS/Platform+Configurator  for saucelabs possibilities.</a></li>
			
			<li><a href="http://seleniumhq.github.io/selenium/docs/api/javascript/index.html%0D%20%20for%20the%20webdriver%20API.">http://seleniumhq.github.io/selenium/docs/api/javascript/index.html  for the webdriver API.</a></li>
			</ul>
	</dd>
