...
<head>
	...
	<title>dwv Class: WorkerTask</title>
...
<hr>
<dt>
    <h4 class="name" id="WorkerTask"><span class="type-signature"></span>new WorkerTask(script, callback, message)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The worker script.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">The worker callback.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The data to pass to the worker.</td>
        </tr>
		...
		<ul class="dummy">
			<li>
				<a href="src_utils_thread.js.html">src/utils/thread.js</a>,
				 <a href="src_utils_thread.js.html#sunlight-1-line-179">line 179</a>
			</li>
		</ul>
	</dd>
