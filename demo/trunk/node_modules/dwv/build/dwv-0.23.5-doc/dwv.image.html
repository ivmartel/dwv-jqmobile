...
<head>
	...
	<title>dwv Namespace: image</title>
		...
		<ul class="dummy">
			<li>
				<a href="src_image_image.js.html">src/image/image.js</a>,
				 <a href="src_image_image.js.html#sunlight-1-line-4">line 4</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".AsynchPixelBufferDecoder"><span class="type-signature">&lt;static> </span>AsynchPixelBufferDecoder(script)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The path to the decoder script to be used by the web worker.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_decoder.js.html">src/image/decoder.js</a>,
				 <a href="src_image_decoder.js.html#sunlight-1-line-21">line 21</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getDefaultView"><span class="type-signature">&lt;static> </span>getDefaultView(width, height, sliceIndex, imageBuffer, numberOfFrames)</h4>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The width of the coresponding image.</td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The height of the coresponding image.</td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The slice index of the imageData.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>imageBuffer</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The image buffer.</td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The final number of frames.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_domReader.js.html">src/image/domReader.js</a>,
				 <a href="src_image_domReader.js.html#sunlight-1-line-34">line 34</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getViewFromDOMImage"><span class="type-signature">&lt;static> </span>getViewFromDOMImage(image)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The DOM Image.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_domReader.js.html">src/image/domReader.js</a>,
				 <a href="src_image_domReader.js.html#sunlight-1-line-67">line 67</a>
			</li>
		</ul>
	</dd>
...
<div class="param-desc">
    The corresponding view and info.
</div>
...
<hr>
<dt>
    <h4 class="name" id=".getViewFromDOMVideo"><span class="type-signature">&lt;static> </span>getViewFromDOMVideo(video, callback, cbprogress, cbonloadend, dataindex)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The DOM Video.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The function to call once the data is loaded.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>cbprogress</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The function to call to report progress.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>cbonloadend</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The function to call to report load end.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>dataindex</code></td>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The data index.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_domReader.js.html">src/image/domReader.js</a>,
				 <a href="src_image_domReader.js.html#sunlight-1-line-112">line 112</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".imageDataToBuffer"><span class="type-signature">&lt;static> </span>imageDataToBuffer(imageData)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The ImageData taken from a context.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_domReader.js.html">src/image/domReader.js</a>,
				 <a href="src_image_domReader.js.html#sunlight-1-line-10">line 10</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".SynchPixelBufferDecoder"><span class="type-signature">&lt;static> </span>SynchPixelBufferDecoder(algoName)</h4>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>algoName</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The decompression algorithm name.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_image_decoder.js.html">src/image/decoder.js</a>,
				 <a href="src_image_decoder.js.html#sunlight-1-line-76">line 76</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".WindowLevel"><span class="type-signature">&lt;static> </span>WindowLevel()</h4>
...
<dd>
    ...
    <div class="description">
        WindowLevel class.References:- DICOM <a href="http://dicom.nema.org/dicom/2013/output/chtml/part03/sect_C.11.html#sect_C.11.2.1.2">Window Center and Window Width</a>Pseudo-code: if (x <= c - 0.5 - (w-1)/2), then y = ymin else if (x > c - 0.5 + (w-1)/2), then y = ymax, else y = ((x - (c - 0.5)) / (w-1) + 0.5) * (ymax - ymin) + ymin
    </div>
		...
		<ul class="dummy">
			<li>
				<a href="src_image_view.js.html">src/image/view.js</a>,
				 <a href="src_image_view.js.html#sunlight-1-line-14">line 14</a>
			</li>
		</ul>
	</dd>
