...
<head>
	...
	<title>dwv Namespace: utils</title>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_string.js.html">src/utils/string.js</a>,
				 <a href="src_utils_string.js.html#sunlight-1-line-4">line 4</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".capitaliseFirstLetter"><span class="type-signature">&lt;static> </span>capitaliseFirstLetter(string)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The string to capitalise the first letter.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_string.js.html">src/utils/string.js</a>,
				 <a href="src_utils_string.js.html#sunlight-1-line-11">line 11</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".decodeKeyValueUri"><span class="type-signature">&lt;static> </span>decodeKeyValueUri(uri, replaceMode)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The URI to decode.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>replaceMode</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The key replace more.  replaceMode can be:  - key (default): keep the key  - other than key: do not use the key  'file' is a special case where the '?' of the query is not kept.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_uri.js.html">src/utils/uri.js</a>,
				 <a href="src_utils_uri.js.html#sunlight-1-line-88">line 88</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".decodeManifest"><span class="type-signature">&lt;static> </span>decodeManifest(manifest, nslices)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The manifest to decode.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>nslices</code></td>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The number of slices to load.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_uri.js.html">src/utils/uri.js</a>,
				 <a href="src_utils_uri.js.html#sunlight-1-line-207">line 207</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getUriQuery"><span class="type-signature">&lt;static> </span>getUriQuery(uri)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The input URI.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_uri.js.html">src/utils/uri.js</a>,
				 <a href="src_utils_uri.js.html#sunlight-1-line-44">line 44</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".MultiProgressHandler"><span class="type-signature">&lt;static> </span>MultiProgressHandler(callback)</h4>
...
<span class="param-type">function</span>
            ...
            <td class="description last">The function to pass the global progress to.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_progress.js.html">src/utils/progress.js</a>,
				 <a href="src_utils_progress.js.html#sunlight-1-line-11">line 11</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".replaceFlags"><span class="type-signature">&lt;static> </span>replaceFlags(inputStr, values)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">A object of {value, unit}.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_string.js.html">src/utils/string.js</a>,
				 <a href="src_utils_string.js.html#sunlight-1-line-67">line 67</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">String</span>
    ...
    <pre class="sunlight-highlight-javascript">var values = {&quot;length&quot;: { &quot;value&quot;: 33, &quot;unit&quot;: &quot;cm&quot; } };   var str = &quot;The length is: {length}.&quot;;   var res = dwv.utils.replaceFlags(str, values); // &quot;The length is: 33 cm.&quot;</pre>
...
<hr>
<dt>
    <h4 class="name" id=".replaceFlags2"><span class="type-signature">&lt;static> </span>replaceFlags2(inputStr, values)</h4>
...
<span class="param-type">Array</span>
            ...
            <td class="description last">An array of strings.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_string.js.html">src/utils/string.js</a>,
				 <a href="src_utils_string.js.html#sunlight-1-line-118">line 118</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">String</span>
    ...
    <pre class="sunlight-highlight-javascript">var values = [&quot;a&quot;, &quot;b&quot;];   var str = &quot;The length is: {v0}. The size is: {v1}&quot;;   var res = dwv.utils.replaceFlags2(str, values); // &quot;The length is: a. The size is: b&quot;</pre>
...
<hr>
<dt>
    <h4 class="name" id=".splitKeyValueString"><span class="type-signature">&lt;static> </span>splitKeyValueString(inputStr)</h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The string to split.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_string.js.html">src/utils/string.js</a>,
				 <a href="src_utils_string.js.html#sunlight-1-line-27">line 27</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".splitUri"><span class="type-signature">&lt;static> </span>splitUri(inputStr)</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_utils_uri.js.html">src/utils/uri.js</a>,
				 <a href="src_utils_uri.js.html#sunlight-1-line-16">line 16</a>
			</li>
		</ul>
	</dd>
