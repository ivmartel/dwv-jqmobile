...
<div class="row">
	...
	<h1 class="page-title">Class: Worker</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="Worker"><span class="type-signature"></span>new Worker(parentPool)</h4>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>parentPool</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The parent pool.</td>
        </tr>
		...
		<ul class="dummy">
			<li>
				<a href="src_utils_thread.js.html">src/utils/thread.js</a>,
				 <a href="src_utils_thread.js.html#sunlight-1-line-105">line 105</a>
			</li>
		</ul>
	</dd>
