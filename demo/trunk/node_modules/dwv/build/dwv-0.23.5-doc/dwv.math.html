...
<head>
	...
	<title>dwv Namespace: math</title>
...
<div class="row">
	...
	<h1 class="page-title">Namespace: math</h1>
<section>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_bucketQueue.js.html">src/math/bucketQueue.js</a>,
				 <a href="src_math_bucketQueue.js.html#sunlight-1-line-4">line 4</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".computeGradient"><span class="type-signature">&lt;static> </span>computeGradient()</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_scissors.js.html">src/math/scissors.js</a>,
				 <a href="src_math_scissors.js.html#sunlight-1-line-68">line 68</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".computeGreyscale"><span class="type-signature">&lt;static> </span>computeGreyscale()</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_scissors.js.html">src/math/scissors.js</a>,
				 <a href="src_math_scissors.js.html#sunlight-1-line-11">line 11</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".computeLaplace"><span class="type-signature">&lt;static> </span>computeLaplace()</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_scissors.js.html">src/math/scissors.js</a>,
				 <a href="src_math_scissors.js.html#sunlight-1-line-108">line 108</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getAngle"><span class="type-signature">&lt;static> </span>getAngle(line0, line1)</h4>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>line0</code></td>
            ...
            <td class="description last">The first line.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>line1</code></td>
            ...
            <td class="description last">The second line.</td>
        </tr>
		...
		<ul class="dummy">
			<li>
				<a href="src_math_shapes.js.html">src/math/shapes.js</a>,
				 <a href="src_math_shapes.js.html#sunlight-1-line-226">line 226</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getIdentityMat33"><span class="type-signature">&lt;static> </span>getIdentityMat33()</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_matrix.js.html">src/math/matrix.js</a>,
				 <a href="src_math_matrix.js.html#sunlight-1-line-78">line 78</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getPerpendicularLine"><span class="type-signature">&lt;static> </span>getPerpendicularLine(line, point, length)</h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The line to be perpendicular to.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The middle point of the perpendicular line.</td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last">The length of the perpendicular line.</td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_shapes.js.html">src/math/shapes.js</a>,
				 <a href="src_math_shapes.js.html#sunlight-1-line-249">line 249</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".getStats"><span class="type-signature">&lt;static> </span>getStats()</h4>
...
<dd>
    ...
    <div class="description">
        Get the minimum, maximum, mean and standard deviationof an array of values.Note: could use <a href="https://github.com/tmcw/simple-statistics">https://github.com/tmcw/simple-statistics</a>.
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_stats.js.html">src/math/stats.js</a>,
				 <a href="src_math_stats.js.html#sunlight-1-line-10">line 10</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".guid"><span class="type-signature">&lt;static> </span>guid()</h4>
...
<dd>
    ...
    <div class="description">
        Unique ID generator.See <a href="http://stackoverflow.com/questions/105034/create-guid-uuid-in-javascript">http://stackoverflow.com/questions/105034/create-guid-uuid-in-javascript</a>and this <a href="http://stackoverflow.com/a/13403498">answer</a>.
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="src_math_stats.js.html">src/math/stats.js</a>,
				 <a href="src_math_stats.js.html#sunlight-1-line-46">line 46</a>
			</li>
		</ul>
	</dd>
