...
<head>
	...
	<title>dwv Source: src/app/application.js</title>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h1 class="page-title">Source: src/app/application.js</h1>
    
<section>
    <article>
        <pre
            class="sunlight-highlight-javascript linenums">/** @namespace */
var dwv = dwv || {};
