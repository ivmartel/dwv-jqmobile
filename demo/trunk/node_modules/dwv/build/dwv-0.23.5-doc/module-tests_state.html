...
<head>
	...
	<title>dwv Module: tests/state</title>
...
<div class="row">
	...
	<h1 class="page-title">Module: tests/state</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="module:tests/state"><span class="type-signature"></span>(require("tests/state"))()</h4>
