        ...
        for (var r = 1; r < table.rows.length; ++r) {
            ...
            for (var c = 0; c < cells.length; ++c) {
                ...
                if (isEditable) {
                    // color
                    if (c === 4) {
                        dwvjq.html.makeCellEditable(cells[c], createColorOnKeyUp(drawDetails), "color");
                    }
                    // text
                    else if (c === 5) {
                        dwvjq.html.makeCellEditable(cells[c], createTextOnKeyUp(drawDetails));
                    }
                    // long text
                    else if (c === 6) {
                        dwvjq.html.makeCellEditable(cells[c], createLongTextOnKeyUp(drawDetails));
                    }
                }
                else {
                    // id: link to image
